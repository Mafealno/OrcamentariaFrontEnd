...
function ArquivoOrcamento(props) {
    ...
    if(props.orcamentoSelecionado.CLIENTE_ORCAMENTO){
        return (
            <NewWindow>
            <PDFViewer className="h-100-pc w-100-pc">
                ...
                title = {"ORCAMENTO_" + 
                    ...
                    '_' + props.orcamentoSelecionado.CLIENTE_ORCAMENTO.NOME_PESSOA.toUpperCase().replace(' ', '_') + 
                            ...
                            <View style={styles.sessao}>
                                <Tabela estilo={{height : 150}}>
                                    ...
                                    <Linha>
                                        ...
                                        <Coluna estilo={{ flexGrow: 1, alignItems: 'flex-start' }}>{props.orcamentoSelecionado.CLIENTE_ORCAMENTO.NOME_PESSOA}</Coluna>
                                    </Linha>
                                    <Linha>
                                        ...
                                        <Coluna estilo={{ flexGrow: 1, alignItems: 'flex-start'}}>
                                            {props.orcamentoSelecionado.CLIENTE_ORCAMENTO.LIST_CONTATO && (
                                                '(' + props.orcamentoSelecionado.CLIENTE_ORCAMENTO.LIST_CONTATO.filter((item) => 
                        ...
                        <View style={[styles.sessao]} fixed>
                            ...
                            <View style={[styles.sessao]}>
                                <Text style={[styles.textoPadrao]}>
                                    ...
                                    INTUMESCENTE {props.orcamentoSelecionado.PRODUTO.FABRICANTE.NOME_PESSOA.toUpperCase() + ' ' + props.orcamentoSelecionado.PRODUTO.NOME_MATERIAL.toUpperCase() + ' '} 
                    ...
                    <Page style={styles.page}>
                        <View style={styles.body}>
                            ...
                            <View style={[styles.sessao]}>
                                ...
                                <Text style={[styles.textoPadrao]}>
                                    {'-'} Aplicação da TINTA INTUMESCENTE {props.orcamentoSelecionado.PRODUTO.FABRICANTE.NOME_PESSOA.toUpperCase() + ' ' + props.orcamentoSelecionado.PRODUTO.NOME_MATERIAL.toUpperCase()} conforme 
